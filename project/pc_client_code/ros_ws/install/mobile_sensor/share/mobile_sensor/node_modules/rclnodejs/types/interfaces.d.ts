...
declare module 'rclnodejs' {
  ...
  namespace kobot_msgs {
    namespace msg {
      export interface FloorSensor {
        intensity: number[] | Uint8Array;
      }
      export interface FloorSensorConstructor {
        new(other?: FloorSensor): FloorSensor;
      }
      ...
      export interface LandmarkConstructor {
        new(other?: Landmark): Landmark;
      }
      export interface LandmarkArray {
        landmark_array: kobot_msgs.msg.LandmarkPose[];
      }
      export interface LandmarkArrayConstructor {
        new(other?: LandmarkArray): LandmarkArray;
      }
      export interface LandmarkPose {
        id: number;
        rvec: number[] | Float32Array;
        tvec: number[] | Float32Array;
      }
      export interface LandmarkPoseConstructor {
        new(other?: LandmarkPose): LandmarkPose;
      }
      ...
      export interface PheromoneGridConstructor {
        new(other?: PheromoneGrid): PheromoneGrid;
      }
      export interface PheromoneSensor {
        readouts: number[] | Float64Array;
      }
      export interface PheromoneSensorConstructor {
        new(other?: PheromoneSensor): PheromoneSensor;
      }
      export interface RangeBearingSensor {
        range_n_bearing: kobot_msgs.msg.RangeRobotDetector[];
      }
      export interface RangeBearingSensorConstructor {
        new(other?: RangeBearingSensor): RangeBearingSensor;
      }
      export interface RangeRobotDetector {
        is_robot: boolean;
        range: number;
      }
      export interface RangeRobotDetectorConstructor {
        new(other?: RangeRobotDetector): RangeRobotDetector;
      }
      export interface ToF {
        range: number;
        ambient: number;
        signal: number;
        status: number;
      ...
      export interface ToFConstructor {
        new(other?: ToF): ToF;
      }
      export interface ToFArray {
        tof_arr: kobot_msgs.msg.ToF[];
      }
      export interface ToFArrayConstructor {
        new(other?: ToFArray): ToFArray;
      }
      export interface VirtualSensor {
        sensor_list: number[] | Float32Array;
      }
      export interface VirtualSensorConstructor {
        new(other?: VirtualSensor): VirtualSensor;
      }
    }
  }
  ...
  type MessagesMap = {
    ...
    'kobot_msgs/msg/FloorSensor': kobot_msgs.msg.FloorSensor,
    'kobot_msgs/msg/Landmark': kobot_msgs.msg.Landmark,
    'kobot_msgs/msg/LandmarkArray': kobot_msgs.msg.LandmarkArray,
    'kobot_msgs/msg/LandmarkPose': kobot_msgs.msg.LandmarkPose,
    'kobot_msgs/msg/PheromoneGrid': kobot_msgs.msg.PheromoneGrid,
    'kobot_msgs/msg/PheromoneSensor': kobot_msgs.msg.PheromoneSensor,
    'kobot_msgs/msg/RangeBearingSensor': kobot_msgs.msg.RangeBearingSensor,
    'kobot_msgs/msg/RangeRobotDetector': kobot_msgs.msg.RangeRobotDetector,
    'kobot_msgs/msg/ToF': kobot_msgs.msg.ToF,
    'kobot_msgs/msg/ToFArray': kobot_msgs.msg.ToFArray,
    'kobot_msgs/msg/VirtualSensor': kobot_msgs.msg.VirtualSensor,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'kobot_msgs/msg/FloorSensor': kobot_msgs.msg.FloorSensorConstructor,
    'kobot_msgs/msg/Landmark': kobot_msgs.msg.LandmarkConstructor,
    'kobot_msgs/msg/LandmarkArray': kobot_msgs.msg.LandmarkArrayConstructor,
    'kobot_msgs/msg/LandmarkPose': kobot_msgs.msg.LandmarkPoseConstructor,
    'kobot_msgs/msg/PheromoneGrid': kobot_msgs.msg.PheromoneGridConstructor,
    'kobot_msgs/msg/PheromoneSensor': kobot_msgs.msg.PheromoneSensorConstructor,
    'kobot_msgs/msg/RangeBearingSensor': kobot_msgs.msg.RangeBearingSensorConstructor,
    'kobot_msgs/msg/RangeRobotDetector': kobot_msgs.msg.RangeRobotDetectorConstructor,
    'kobot_msgs/msg/ToF': kobot_msgs.msg.ToFConstructor,
    'kobot_msgs/msg/ToFArray': kobot_msgs.msg.ToFArrayConstructor,
    'kobot_msgs/msg/VirtualSensor': kobot_msgs.msg.VirtualSensorConstructor,
