...
def capture_dma():
    ...
    # 2. DRAIN FIFO
    while ((mem32[ADC_FCS] >> 16) & 0xF) != 0:
        _ = mem32[ADC_FIFO]

    # 3. ENABLE FIFO & DREQ
    mem32[ADC_FCS] = (1 << 0) | (1 << 3) | (1 << 16)

    # 4. CONFIGURE DMA
    mem32[DMA_CH0_CTRL_TRIG] = 0   # reset channel
